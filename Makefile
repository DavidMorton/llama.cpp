...
BUILD_TARGETS = \
	main quantize quantize-multipart quantize-stats perplexity embedding vdot q8dot train-text-from-scratch convert-llama2c-to-ggml \
...
quantize-multipart: examples/quantize-multipart/quantize-multipart.cpp                      build-info.o ggml.o llama.o $(OBJS)
	$(CXX) $(CXXFLAGS) $(filter-out %.h,$^) -o $@ $(LDFLAGS)
